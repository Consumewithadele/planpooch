...
require_once(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('gkh_rss_import').'lib/lastRSS.php');
require_once(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('gkh_rss_import').'lib/smarttrim.php');
 ...
 */
class tx_gkhrssimport_pi1 extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	...
	function smart_trim( $text, $conf )
	{
		...
		$text = smart_trim($text,$flex_itemlength);
		return $text;
	}
}
