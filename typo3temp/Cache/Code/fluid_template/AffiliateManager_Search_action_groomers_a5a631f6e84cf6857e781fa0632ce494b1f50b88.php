<?php
class FluidCache_AffiliateManager_Search_action_groomers_a5a631f6e84cf6857e781fa0632ce494b1f50b88 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
.ui.planpooch-button.button {
 ...
 <div class="ui container">
        <div class="products">
          <div class="product-header">Groomers</div>
          <div class="location">
            <div class="iu image">
              <img src="fileadmin/plannedpooch/version2/images/groomers.png" width="100" class="ui centered results-image image" />
            </div>
...
$arguments1['action'] = 'searchGroomers';
