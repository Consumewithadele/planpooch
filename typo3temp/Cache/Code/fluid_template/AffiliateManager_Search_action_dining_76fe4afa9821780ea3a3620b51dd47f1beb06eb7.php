<?php
class FluidCache_AffiliateManager_Search_action_dining_76fe4afa9821780ea3a3620b51dd47f1beb06eb7 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
.ui.planpooch-button.button {
    ...
    max-width: 275px !important;
      ...
      <div class="ui container">
        <div class="products">
          <div class="product-header">Dining</div>
          <div class="location">
            <div class="iu image">
              <img src="fileadmin/plannedpooch/version2/images/results-image.png" width="100" class="ui centered results-image image" />
            </div>
...
$arguments1['action'] = 'searchDining';
