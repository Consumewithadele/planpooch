<?php
class FluidCache_Standalone_partial_Menu_Type_2_c8e70a72ff26a6b636375e5ee90714fbc8487958 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
';
// Rendering ViewHelper TYPO3\CMS\FluidStyledContent\ViewHelpers\Menu\ListViewHelper
$arguments1 = array();
...
$arguments37 = array();
$arguments37['partial'] = 'Menu/Directory';
// Rendering Array
$array38 = array();
// Rendering Array
$array39 = array();
$array39['0'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('page'), 'uid', $renderingContext);
$array38['pageUids'] = $array39;
...
$output9 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments37, $renderChildrenClosure40, $renderingContext);
...
$viewHelper41 = $self->getViewHelper('$viewHelper41', $renderingContext, 'TYPO3\CMS\FluidStyledContent\ViewHelpers\Menu\ListViewHelper');
$viewHelper41->setArguments($arguments1);
$viewHelper41->setRenderingContext($renderingContext);
$viewHelper41->setRenderChildrenClosure($renderChildrenClosure2);
// End of ViewHelper TYPO3\CMS\FluidStyledContent\ViewHelpers\Menu\ListViewHelper
