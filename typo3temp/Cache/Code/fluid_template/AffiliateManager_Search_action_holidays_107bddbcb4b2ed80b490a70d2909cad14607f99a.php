<?php
class FluidCache_AffiliateManager_Search_action_holidays_107bddbcb4b2ed80b490a70d2909cad14607f99a extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="ui container">
        <div class="products">
          <div class="product-header">Hotels</div>
          <div class="location">
            <div class="iu image">
              <img src="fileadmin/plannedpooch/version2/images/holidays.png" width="100" class="ui centered results-image image" />
            </div>
...
$arguments1['action'] = 'searchHolidays';
